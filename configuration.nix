...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc4c7edc0ed73430879372";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc4c7edc0ed73430879372"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc4c7edc0ed73430879372.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc4c7edc0ed73430879372
          
          cd /home/${user}/polyflow_robot_68dc4c7edc0ed73430879372/workspace/src/webrtc
          pip install -r requirements.txt

          cd /home/${user}/polyflow_robot_68dc4c7edc0ed73430879372/workspace
